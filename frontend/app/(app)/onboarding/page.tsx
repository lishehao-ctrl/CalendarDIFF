    ...
    <div className="space-y-5">
      <Card className="max-w-3xl p-8">
        ...
        <p className="mt-4 text-sm leading-7 text-[#596270]">
          Your account is active, but the workspace has no active source yet. Start by connecting your Canvas ICS link or Gmail so review and linking work can begin.
        </p>
