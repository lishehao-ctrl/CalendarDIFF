...
function normalizeUsageSummary(raw: unknown): SyncUsageSummary | null {
  ...
  return {
    ...
    protocols: typeof value.protocol_counts === "object" && value.protocol_counts ? (value.protocol_counts as Record<string, number>) : {},
