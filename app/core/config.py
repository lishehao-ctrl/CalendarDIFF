...
class Settings(BaseSettings):
    ...
    judge_llm_responses_base_url: str | None = None
    judge_llm_api_key: str | None = None
    judge_llm_model: str | None = None
    judge_llm_protocol: str | None = None
    helper_llm_base_url: str | None = None
    helper_llm_responses_base_url: str | None = None
    helper_llm_api_key: str | None = None
    helper_llm_model: str | None = None
    helper_llm_protocol: str | None = None
    helper_llm_extra_body_json: str | None = None
    helper_agent_parallelism: int = 8
    ...
    agent_trace_persistence_enabled: bool = False
