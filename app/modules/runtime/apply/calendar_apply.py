...
from app.modules.runtime.apply.observation_store import (
    deactivate_observation,
    retire_active_observation_for_unresolved_transition,
    upsert_observation,
)
from app.modules.runtime.apply.unresolved_store import (
...
def apply_calendar_observations(
    *,
    ...
    for index, record in enumerate(records):
        ...
        logger.debug(
            "runtime.apply.observation.calendar request_id=%s source_id=%s entity_uid=%s external_event_id=%s",
            request_id,
            source.id,
            entity_uid,
            external_event_id,
