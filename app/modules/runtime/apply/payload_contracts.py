...
from app.modules.runtime.connectors.llm_parsers.schemas import GmailDirectiveExtractionResponse
...
def _invalid_payload_message(*, record_type: str, record_index: int, detail: str) -> str:
    return f"runtime_apply_payload_invalid record_type={record_type} index={record_index}: {detail}"
