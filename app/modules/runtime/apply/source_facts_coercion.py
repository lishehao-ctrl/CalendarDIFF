...
from app.modules.runtime.apply.time_utils import as_utc
from app.modules.runtime.apply.source_facts_types import CanonicalEventInput


def coerce_calendar_payload(*, payload: dict) -> CanonicalEventInput:
    from app.modules.runtime.apply.payload_extractors import extract_course_parse
    ...
    try:
        ...
        raise RuntimeError("runtime_apply_payload_invalid: calendar payload missing source_facts.external_event_id") from exc
    uid = source_facts.external_event_id
    if not uid:
        raise RuntimeError("runtime_apply_payload_invalid: calendar payload missing source_facts.external_event_id")
