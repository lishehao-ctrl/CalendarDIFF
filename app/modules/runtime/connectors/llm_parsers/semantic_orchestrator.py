...
from app.modules.runtime.apply.semantic_event_service import normalize_semantic_event, split_due_parts
from app.modules.runtime.connectors.ics_delta.fingerprint import build_component_key, build_external_event_id
from app.modules.runtime.connectors.llm_parsers.contracts import LlmParseError, ParserContext, ParserOutput
from app.modules.runtime.connectors.llm_parsers.gmail_parser_records import build_atomic_record, build_directive_record
    ...
    *,
    ...
    try:
        typed_result = invoke_llm_typed(
            ...
            invoke_json_fn=lambda db_session, request: invoke_llm_json(db_session, invoke_request=request),
        )
