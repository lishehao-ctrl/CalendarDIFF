...
GMAIL_NEGATIVE_NON_TARGET_PHRASES = (
    ...
    "shipping exception notification",
...
def route_gmail_message(
    *,
    ...
    target_signal = course_signal or sender_signal or keyword_signal or positive_time_signal

    if explicit_non_target_signal and not target_signal:
        return RouteDecision(route="skip_unknown", sender_family=sender_family)

    if non_target_sender_signal and not target_signal:
        return RouteDecision(route="skip_unknown", sender_family=sender_family)
