...
_CATALOG: dict[LanguageCodeLiteral, dict[str, str]] = {
    "en": {
        ...
        "agents.context.family.action.review_observed_labels": "Review observed labels",
        "agents.context.family.action.review_canonical_family": "Review canonical family",
        "agents.context.family.blocking.pending_raw_type_suggestions": "{pending_count} observed-label suggestions are still waiting for review.",
        ...
        "agents.proposals.family_relink_preview.summary": "Preview moving observed label '{raw_type}' into canonical family '{target_family}'.",
        "agents.proposals.family_relink_preview.reason": "Observed label '{raw_type}' is currently mapped to '{current_family}'. Previewing a move to '{target_family}' would affect {impacted_event_count} active events and {impacted_pending_change_count} pending changes. Matching suggestions: {matching_suggestion_count}.",
        "agents.proposals.family_relink_commit.summary": "Move observed label '{raw_type}' into canonical family '{target_family}'.",
        "agents.proposals.family_relink_commit.reason": "Observed label '{raw_type}' is currently mapped to '{current_family}'. Committing the move to '{target_family}' would affect {impacted_event_count} active events and {impacted_pending_change_count} pending changes.",
        "agents.proposals.label_learning_commit.summary": "Map observed label '{raw_label}' into canonical family '{target_family}'.",
        "agents.proposals.label_learning_commit.reason": "For {course_display}, map observed label '{raw_label}' into existing canonical family '{target_family}' and approve the pending learned-label change.",
        "agents.proposals.change_edit_commit.summary": "Commit a proposal edit for {patch_fields}.",
        "agents.proposals.change_edit_commit.reason": "Updated proposal fields: {patch_fields}. The preview keeps the change pending and currently shows {delta_text}.",
        "agents.proposals.change_edit.field.event_name": "event name",
        "agents.proposals.change_edit.field.due_date": "due date",
        "agents.proposals.change_edit.field.due_time": "due time",
        "agents.proposals.change_edit.field.time_precision": "time precision",
        "agents.proposals.change_edit.field.none": "proposal fields",
        "agents.proposals.change_edit.delta.seconds": "{seconds} seconds",
        "agents.proposals.change_edit.delta.none": "no time delta",
        "agents.ticket.action.change_decision": "change decision",
        "agents.ticket.action.run_source_sync": "source sync",
        "agents.ticket.action.family_relink_commit": "family relink",
        "agents.ticket.action.label_learning_add_alias_commit": "label learning commit",
        "agents.ticket.action.proposal_edit_commit": "proposal edit commit",
        "agents.ticket.confirm.summary": "Confirm {action_label}.",
        "agents.ticket.cancel.summary": "Cancel {action_label}.",
        "agents.ticket.transition.waiting_confirm": "{action_label} is waiting for confirmation.",
        "agents.ticket.transition.executed": "{action_label} was executed successfully.",
        "agents.ticket.transition.canceled": "{action_label} was canceled before execution.",
        "agents.ticket.transition.expired": "{action_label} expired before confirmation.",
        "agents.ticket.transition.failed": "{action_label} attempted execution but failed.",
        "agents.activity.ticket.summary.open": "{action_label} is waiting for confirmation.",
        "agents.activity.ticket.summary.executed": "{action_label} was executed.",
        "agents.activity.ticket.summary.canceled": "{action_label} was canceled.",
        "agents.activity.ticket.summary.expired": "{action_label} expired.",
        "agents.activity.ticket.summary.failed": "{action_label} failed during execution.",
        "agents.activity.ticket.detail.open": "The approval ticket is still waiting for confirmation.",
        "agents.activity.ticket.detail.executed": "The approval ticket executed through the bounded agent gateway.",
        "agents.activity.ticket.detail.canceled": "The approval ticket was canceled before execution.",
        "agents.activity.ticket.detail.expired": "The approval ticket expired before confirmation.",
        "agents.activity.ticket.detail.failed": "The approval ticket attempted execution but failed.",
    },
    "zh-CN": {
        ...
        "agents.context.family.action.review_observed_labels": "审核观察标签",
        "agents.context.family.action.review_canonical_family": "审核标准 family",
        "agents.context.family.blocking.pending_raw_type_suggestions": "还有 {pending_count} 条观察标签建议等待处理。",
        ...
        "agents.proposals.family_relink_preview.summary": "预览将观察标签“{raw_type}”迁移到标准 family“{target_family}”。",
        "agents.proposals.family_relink_preview.reason": "观察标签“{raw_type}”当前属于“{current_family}”。如果预览迁移到“{target_family}”，会影响 {impacted_event_count} 条活跃事件、{impacted_pending_change_count} 条待处理变更，并关联 {matching_suggestion_count} 条匹配建议。",
        "agents.proposals.family_relink_commit.summary": "将观察标签“{raw_type}”迁移到标准 family“{target_family}”。",
        "agents.proposals.family_relink_commit.reason": "观察标签“{raw_type}”当前属于“{current_family}”。正式迁移到“{target_family}”后，会影响 {impacted_event_count} 条活跃事件和 {impacted_pending_change_count} 条待处理变更。",
        "agents.proposals.label_learning_commit.summary": "将观察标签“{raw_label}”学习到标准 family“{target_family}”。",
        "agents.proposals.label_learning_commit.reason": "针对 {course_display}，把观察标签“{raw_label}”加入已有标准 family“{target_family}”，并通过这条待处理的标签学习变更。",
        "agents.proposals.change_edit_commit.summary": "提交一条针对 {patch_fields} 的 proposal 编辑。",
        "agents.proposals.change_edit_commit.reason": "本次更新的 proposal 字段包括：{patch_fields}。预览结果会保持变更处于待处理状态，当前显示的时间差为 {delta_text}。",
        "agents.proposals.change_edit.field.event_name": "项目名称",
        "agents.proposals.change_edit.field.due_date": "截止日期",
        "agents.proposals.change_edit.field.due_time": "截止时间",
        "agents.proposals.change_edit.field.time_precision": "时间精度",
        "agents.proposals.change_edit.field.none": "proposal 字段",
        "agents.proposals.change_edit.delta.seconds": "{seconds} 秒",
        "agents.proposals.change_edit.delta.none": "没有时间差",
        "agents.ticket.action.change_decision": "变更决策",
        "agents.ticket.action.run_source_sync": "来源同步",
        "agents.ticket.action.family_relink_commit": "family 重连",
        "agents.ticket.action.label_learning_add_alias_commit": "标签学习提交",
        "agents.ticket.action.proposal_edit_commit": "proposal 编辑提交",
        "agents.ticket.confirm.summary": "确认执行“{action_label}”。",
        "agents.ticket.cancel.summary": "取消“{action_label}”。",
        "agents.ticket.transition.waiting_confirm": "“{action_label}”正在等待确认。",
        "agents.ticket.transition.executed": "“{action_label}”已执行完成。",
        "agents.ticket.transition.canceled": "“{action_label}”已在执行前取消。",
        "agents.ticket.transition.expired": "“{action_label}”在确认前已过期。",
        "agents.ticket.transition.failed": "“{action_label}”执行失败。",
        "agents.activity.ticket.summary.open": "“{action_label}”正在等待确认。",
        "agents.activity.ticket.summary.executed": "“{action_label}”已执行。",
        "agents.activity.ticket.summary.canceled": "“{action_label}”已取消。",
        "agents.activity.ticket.summary.expired": "“{action_label}”已过期。",
        "agents.activity.ticket.summary.failed": "“{action_label}”执行失败。",
        "agents.activity.ticket.detail.open": "这张审批票据仍在等待确认。",
        "agents.activity.ticket.detail.executed": "这张审批票据已经通过受控 agent 网关执行完成。",
        "agents.activity.ticket.detail.canceled": "这张审批票据已在执行前取消。",
        "agents.activity.ticket.detail.expired": "这张审批票据在确认前已经过期。",
        "agents.activity.ticket.detail.failed": "这张审批票据尝试执行但失败了。",
    },
}
