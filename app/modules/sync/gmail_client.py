...
class GmailClient:
    ...
    def build_authorization_url(self, *, state: str) -> str:
        ...
        params = {
            "client_id": self._settings.gmail_oauth_client_id or "",
            "redirect_uri": self._settings.gmail_oauth_redirect_uri or "",
            "response_type": "code",
    ...
    def exchange_code(self, *, code: str) -> GmailOAuthTokens:
        ...
        payload = {
            "code": code,
            "client_id": self._settings.gmail_oauth_client_id or "",
            "client_secret": self._settings.gmail_oauth_client_secret or "",
            "redirect_uri": self._settings.gmail_oauth_redirect_uri or "",
    ...
    def _assert_oauth_configured(self) -> None:
        if (
            not self._settings.gmail_oauth_client_id
            or not self._settings.gmail_oauth_client_secret
            or not self._settings.gmail_oauth_redirect_uri
        ):
