...
def create_course_work_item_family(
    ...
    *,
    ...
    from app.modules.families.raw_type_service import replace_family_raw_types
...
def add_raw_type_to_course_work_item_family(
    ...
    *,
    ...
    from app.modules.families.raw_type_service import create_course_raw_type
...
def resolve_course_work_item_family(
    ...
    *,
    ...
    from app.modules.families.raw_type_service import find_course_raw_type
