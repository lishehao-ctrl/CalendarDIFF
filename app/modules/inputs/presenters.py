...
def to_input_response(input: Input, *, next_check_at: datetime | None, last_result: str | None) -> InputResponse:
    return InputResponse(
        ...
        term_code=input.user_term.code if input.user_term is not None else None,
        term_label=input.user_term.label if input.user_term is not None else None,
        term_scope=input.term_scope,
