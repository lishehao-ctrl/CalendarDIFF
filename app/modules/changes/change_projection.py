...
class ChangeProjectionContext:
    ...
    def change_summary(self, change: Change) -> ChangeSummaryPayload:
...
def build_change_projection_context(db: Session, *, user_id: int, changes: list[Change]) -> ChangeProjectionContext:
    ...
    return ChangeProjectionContext(
...
__all__ = [
    "ChangeProjectionContext",
    "build_change_projection_context",
]
