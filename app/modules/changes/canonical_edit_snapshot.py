...
from app.modules.changes.canonical_edit_errors import CanonicalEditNotFoundError
    ...
    *,
    ...
    if entity_row is not None and entity_row.event_name and entity_row.due_date is not None:
        ...
        current_family_name = require_latest_family_label(
            ...
            context=f"changes.canonical_edit_snapshot approved entity_uid={entity_uid}",
        )
        ...
        if parsed is not None:
            ...
            return {
                ...
                "family_name": require_latest_family_label(
                    family_id=parsed.family_id,
                    latest_family_labels=latest_family_labels,
                    context=f"changes.canonical_edit_snapshot pending entity_uid={entity_uid}",
                ),
